...
import { renderMarkdown, renderJson, renderYaml } from '../../../src/core/render'; // Adjust path as needed
import './App.css';
...
function App() {
  ...
  const [outputFormat, setOutputFormat] = useState<'markdown' | 'json' | 'yaml'>('markdown');
    ...
    <div className="App">
      ...
      <div className="input-section">
        ...
        <div className="controls">
          <select
            value={outputFormat}
            onChange={(e) => setOutputFormat(e.target.value as 'markdown' | 'json' | 'yaml')}
            disabled={loading}
          >
